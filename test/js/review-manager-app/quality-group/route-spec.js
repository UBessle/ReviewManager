describe('QualityGroup Routes: ', function() {
    beforeEach(module('reviewManagerApp.qualityGroup'));
	...
	describe('Create route: ', function() {
		beforeEach(inject(
			function($httpBackend) {
				...
				$httpBackend.whenGET('/api/qualityGroup/create').respond([]);
	...
	describe('Edit route: ', function() {
		beforeEach(inject(
			function($httpBackend) {
				$httpBackend.whenGET('create-edit.html').respond(200, 'list page');
				$httpBackend.whenGET('/api/qualityGroup/1').respond([]);
